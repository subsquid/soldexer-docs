...
<CardGroup cols={3}>
  <Card title="Swaps on Solana" icon="arrows-rotate" href="/examples/example-1-dex-swaps">
  ...
  <Card title="Metaplex NFT metadata" icon="image" href="/examples/example-2-metaplex-nft-metadata">
  ...
  <Card title="pump.fun tokens" icon="rocket" href="/examples/example-3-pumpfun-tokens">
