...
[Pipes](/pipes/overview) are great when you need something you could add to an existing system, but sometimes an all-in-one, complete indexing solution is preferable. With SQD's TypeScript SDK you can make an indexer (a **squid**) that bundles:
...
If that's something you'd like, then this section is for you.

## Architecture of squids
