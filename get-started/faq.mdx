...
<Accordion title="How does it work?">
  Soldexer uses a decentralized network of 1,900+ worker nodes ([SQD
...
<Accordion title="What's the connection between SQD and Soldexer?">
  ...
  1,900+ worker nodes ensure reliable data processing and transparent
  architecture.
</Accordion>
...
| Cost Efficiency            | ✅ Pay-as-you-go, ultra-economic                     | ❌ High infra/validator maintenance                                               | ⚪ Free-to-query for basic use                         | ❌ Higher costs for enterprise-grade services; pay-as-you-go models can be expensive at scale |
...
<Accordion title="Can I use Soldexer with my existing data pipeline?">
  ...
  integrate with existing ETL pipelines, databases, or analytics tools. See e.g.
  [this example by Cherry
